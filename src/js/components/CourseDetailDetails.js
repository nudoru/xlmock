...
class CourseDetailDetails extends React.Component {
  ...
  render() {
    return (<div className='course-detail__details'>
      ...
      <div className='course-detail__details--metadata'>
        <div className='course-detail__details--metadata--tags'>
          <Tag negative>Infrastructure</Tag>
        </div>
        <div className='course-detail__details--metadata--mobile'>
